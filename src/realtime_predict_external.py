...
MODEL_PATH = "models/turkish_lip_reading_external.keras"
LABELS_PATH = "data/external_processed/labels.json"
...
def main():
    ...
    with mp_face_mesh.FaceMesh(
        ...
        while True:
            ...
            cv2.imshow("External Turkish Lip Reading", frame)
            ...
            if key == ord(" "):
                ...
                while len(sequence) < SEQUENCE_LENGTH:
                    ...
                    if results.multi_face_landmarks:
                        ...
                        if mouth_crop.size > 0:
                            ...
                            cv2.putText(
                                frame,
                                f"Kaydediliyor: {len(sequence)}/{SEQUENCE_LENGTH}",
                                (20, 40),
                                cv2.FONT_HERSHEY_SIMPLEX,
                                1,
                                (0, 0, 255),
                ...
                if len(sequence) == SEQUENCE_LENGTH:
                    ...
                    prediction_text = index_to_label[predicted_index]
